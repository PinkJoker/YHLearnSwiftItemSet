...
class AppDelegate: UIResponder, UIApplicationDelegate,CAAnimationDelegate {
    ...
    func animateMask() {
        ...
        keyFrameAnimation.beginTime = CACurrentMediaTime() + 0.1
        keyFrameAnimation.timingFunctions = [CAMediaTimingFunction(name: kCAMediaTimingFunctionLinear), CAMediaTimingFunction(name: kCAMediaTimingFunctionEaseOut)]
